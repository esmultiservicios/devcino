...
$comentario = mb_convert_case("Ingreso al Modulo de Transito", MB_CASE_TITLE, "UTF-8");   
...
<div class="container-fluid">
    ...
    <form class="form-inline" id="form_main_transito"> 
      ...
      <div class="form-group mr-1">
         <input type="text" placeholder="Buscar por: Expediente, Nombre o Identidad" data-toggle="tooltip" data-placement="top" title="Buscar por: Expediente, Nombre, Apellido o Identidad" id="bs-regis" autofocus class="form-control" size="38"/>
      </div>
