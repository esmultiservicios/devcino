...
$comentario = mb_convert_case("Ingreso al Modulo de Reporte Nota Operatoria", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte Nota Operatoria :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Nota Operatoria</li>
	</ol>

    <form class="form-inline" id="form_main_nota_operatoria">
		<div class="form-group mr-1">
			<div class="input-group">				
				<div class="input-group-append">				
					<span class="input-group-text"><div class="sb-nav-link-icon"></div>Profesional</span>
				</div>
				 <select id="colaborador" name="colaborador" class="form-control" data-toggle="tooltip" data-placement="top" title="Profesional">   				   		 
		...
		<div class="form-group mr-1">
			<div class="input-group">				
				...
				<input type="date" required="required" id="fecha_i" name="fecha_i" style="width: 159px;" value="<?php echo date ("Y-m-d");?>" class="form-control"/>
			</div>		   
		</div>		
		<div class="form-group mr-1">
			<div class="input-group">				
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_nota_operatoria.php"; 		
