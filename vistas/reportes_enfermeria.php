...
<head>
    ...
    <title>Reporte Confirmación :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
    ...
    <form class="form-inline" id="form_main_enfermeria">  
      ...
      <div class="form-group mr-1">
         <input type="text" placeholder="Buscar por: Expediente, Nombre o Identidad" data-toggle="tooltip" data-placement="top" title="Buscar por: Expediente, Nombre, Apellido o Identidad" id="bs-regis" autofocus class="form-control" size="45"/>
      </div>  
