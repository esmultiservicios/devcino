...
<!--FIN MODAL TRANSITO ENVIADA-->

<!--INICIO MODAL TRANSITO RECIBIDA-->
					...
					<div class="col-md-8 mb-3">
					  ...
					  <div class="input-group mb-3">
						  ...
						  <div class="input-group-append" id="buscar_pacientes_atenciones">				
							<a data-toggle="modal" href="#" class="btn btn-outline-success" id="servicio_boton"><div class="sb-nav-link-icon"></div><i class="fas fa-at fa-lg"></i></a>
						  </div>
					   </div>					  
					</div>					
				</div>	
        ...
        <div class="modal-body">		
			<form class="FormularioAjax" id="formulario_pacientes" data-async data-target="#rating-modal" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">			
				...
				<div class="form-row">
					...
					<div class="col-md-3 mb-3">
					  <label for="expedoente">RTN o Identidad <span class="priority">*<span/></label>
				     <input type="number" name="identidad" class="form-control" id="identidad" placeholder="RTN o Identidad" required maxlength="14" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
					</div>			
					<div class="col-md-3 mb-3">
						<label>Fecha de Nacimiento <span class="priority">*<span/></label>
						<input type="date" id="fecha_nac" name="fecha_nac" value="<?php echo date ("Y-m-d");?>" class="form-control" require/>
					</div>						
				</div>	
				<div class="form-row">
					<div class="col-md-3 mb-3">
				...
				<div class="form-row">						
					<div class="col-md-4 mb-3">
					  ...
					  <div class="input-group mb-3">
						  ...
						  <div class="input-group-append" id="buscar_pais_form_pacientes">				
							<a data-toggle="modal" href="#" class="btn btn-outline-success"><div class="sb-nav-link-icon"></div><i class="fas fa-search fa-lg"></i></a>
						  </div>
					   </div>						  
					</div>				
					<div class="col-md-4 mb-3">
					  ...
					  <div class="input-group mb-3">
						  ...
						  <div class="input-group-append" id="buscar_departamento_form_pacientes">				
							<a data-toggle="modal" href="#" class="btn btn-outline-success"><div class="sb-nav-link-icon"></div><i class="fas fa-search fa-lg"></i></a>
						  </div>
					   </div>						  
					</div>
					<div class="col-md-4 mb-3">
					  ...
					  <div class="input-group mb-3">
						  ...
						  <div class="input-group-append" id="buscar_municipio_form_pacientes">				
							<a data-toggle="modal" href="#" class="btn btn-outline-success"><div class="sb-nav-link-icon"></div><i class="fas fa-search fa-lg"></i></a>
						  </div>
					   </div>						  
					</div>				
