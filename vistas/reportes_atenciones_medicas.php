...
$comentario = mb_convert_case("Ingreso al Modulo de Reporte Pacientes Nuevos", MB_CASE_TITLE, "UTF-8");   
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Expediente Clínico</li>
	</ol>
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_expediente_clinico.php"; 		
