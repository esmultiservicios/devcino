...
$comentario = mb_convert_case("Ingreso al Modulo de Reporte Post Operacion", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte Post Operación :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Post Operación</li>
	</ol>
	
    <form class="form-inline" id="form_main_post_operatorio">
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_post_operacion.php"; 		
