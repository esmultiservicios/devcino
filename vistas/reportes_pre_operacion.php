...
$comentario = mb_convert_case("Ingreso al Modulo de Reporte Pre Operacion", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte Pre Operación :: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
	<ol class="breadcrumb mt-2 mb-4">
		...
		<li class="breadcrumb-item active" id="acciones_factura"><span id="label_acciones_factura"></span>Reporte Pre Operación</li>
	</ol>
	
    <form class="form-inline" id="form_main_pre_operacion">
	...
	<?php 
		...
		include "../js/main.php"; 
		include "../js/myjava_reportes_pre_operacion.php"; 		
