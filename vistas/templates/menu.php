		...
		?>
            ...
            <li class="nav-item dropdown active">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false"><i class="fa-solid fa-user-nurse fa-lg"></i>&nbsp;Confirmación</a>
		  ...
		  ?>
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown03">
                    <a class="dropdown-item"
                        href="<?php echo SERVERURL; ?>vistas/atencion_medica_nutricion.php">Atenciones</a>
                </div>
            </li>
            <?php
	    	 }
		   ?>
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                    <a class="dropdown-item"
                        href="<?php echo SERVERURL; ?>vistas/reportes_expediente_clinico.php">Reporte Expediente Clínico
                        Cirugía</a>
                    <a class="dropdown-item"
                        href="<?php echo SERVERURL; ?>vistas/reportes_expediente_clinico_nutricion.php">Reporte
                        Expediente Clínico Nutrición</a>
                    <a class="dropdown-item"
                        href="<?php echo SERVERURL; ?>vistas/reportes_atenciones_medicas.php">Reporte Pacientes
                        Nuevos</a>
                    <a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_pre_operacion.php">Reporte
                        Pre-Operación</a>
                    <a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_nota_operatoria.php">Reporte
                        Nota Operatoria</a>
                    <a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_post_operacion.php">Reporte
                        Post-Operación</a>
		...
		?>
                <li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-gears fa-lg"></i>&nbsp;</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown05">
                        <a class="dropdown-item"
