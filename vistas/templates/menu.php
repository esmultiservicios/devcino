<!-- Navigation -->
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">		
		...
		<?php
		 if ($_SESSION['type']==1 || $_SESSION['type']==2 || $_SESSION['type']==3 || $_SESSION['type']==4){ //SUPER ADMINISTRADOR, ADMINISTRADOR , BARIATRICA, NUTRICION
		?>
		...
		<?php
		 	if ($_SESSION['type']==4 ){ //NUTRICION
		  ?>		  
		  <li class="nav-item dropdown active">
			<a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-user-doctor fa-lg"></i>&nbsp;Profesionales</a>
			<div class="dropdown-menu" aria-labelledby="dropdown03">
			  <a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/atencion_medica_nutricion.php">Atenciones</a>
			</div>
		  </li>
		  <?php
	    	 }
		  ...
		  <li class="nav-item dropdown active">
			<a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-chart-bar fa-lg"></i>&nbsp;Reportes</a>
			<div class="dropdown-menu" aria-labelledby="dropdown05">
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_expediente_clinico.php">Reporte Expediente Clínico Cirugía</a>
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_expediente_clinico_nutricion.php">Reporte Expediente Clínico Nutrición</a>
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_atenciones_medicas.php">Reporte Pacientes Nuevos</a>
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_pre_operacion.php">Reporte Pre-Operación</a>
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_nota_operatoria.php">Reporte Nota Operatoria</a>
				<a class="dropdown-item" href="<?php echo SERVERURL; ?>vistas/reportes_post_operacion.php">Reporte Post-Operación</a>
    ...
    <form class="form-inline my-2 my-lg-0">
	  <ul class="navbar-nav mr-auto">
		...
		?>
		  <li class="nav-item dropdown active">
			<a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-gears fa-lg"></i>&nbsp;</a>
			<div class="dropdown-menu" aria-labelledby="dropdown05">
		...
		<?php
			 if ($_SESSION['type']==1 || $_SESSION['type']==2 || $_SESSION['type']==3 || $_SESSION['type']==4){//SUPER ADMINISTRADOR Y ADMINISTRADOR 
		?>
		  <li class="nav-item dropdown active">
