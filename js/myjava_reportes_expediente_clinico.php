...
$(document).ready(function() {
  $('#form_main_atenciones_medicas #servicio').on('change', function(){	
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_atenciones_medicas #colaborador').on('change', function(){
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_atenciones_medicas #fecha_i').on('change', function(){	
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_atenciones_medicas #fecha_f').on('change', function(){	
     pagination(1);
  });
});
...
function getServicio(){
    var url = '<?php echo SERVERURL; ?>php/reportes_expediente_clinico/getServicio.php';		
	...
	$.ajax({
        ...
        success: function(data){	
		    $('#form_main_atenciones_medicas #servicio').html("");
			$('#form_main_atenciones_medicas #servicio').html(data);
		}			
     });	
}
...
function getProfesionales(){
	...
	$.ajax({
        ...
        url: url,
        success: function(data){	
		    $('#form_main_atenciones_medicas #colaborador').html("");
			$('#form_main_atenciones_medicas #colaborador').html(data);		
		}			
     });	
}
...
function pagination(partida){
	var colaborador = '';
	var desde = $('#form_main_atenciones_medicas #fecha_i').val();
	var hasta = $('#form_main_atenciones_medicas #fecha_f').val();
	var dato = $('#form_main_atenciones_medicas #bs_regis').val();
	var url = '<?php echo SERVERURL; ?>php/reportes_expediente_clinico/paginar.php';	
	
	if($('#form_main_atenciones_medicas #colaborador').val() == "" || $('#form_main_atenciones_medicas #colaborador').val() == null){
		colaborador = "";
	}else{
		colaborador = $('#form_main_atenciones_medicas #colaborador').val();
	}
...
function reporteEXCEL(){
    ...
    url = '<?php echo SERVERURL; ?>php/reportes_expediente_clinico/reporte.php?desde='+desde+'&hasta='+hasta+'&colaborador='+colaborador;
...
function reporteEXCELDiario(){		
	...
	if($('#form_main_atenciones_medicas #servicio').val() == "" || $('#form_main_atenciones_medicas #servicio').val() == null){
		servicio = "";
	}else{
		servicio = $('#form_main_atenciones_medicas #servicio').val();
	}
	...
	var url = '<?php echo SERVERURL; ?>php/reportes_expediente_clinico/reporteDiarioAtenciones.php?desde='+desde+'&hasta='+hasta+'&servicio='+servicio+'&colaborador='+colaborador;
	window.open(url);			
}
...
$('#form_main_atenciones_medicas #reporte_excel').on('click', function(e){
 if (getUsuarioSistema() == 1 || getUsuarioSistema() == 2 || getUsuarioSistema() == 3 || getUsuarioSistema() == 5){
    e.preventDefault();
    reporteEXCEL();
 }else{
...
$('#form_main_atenciones_medicas #reporte_diario').on('click', function(e){ // add event submit We don't want this to act as a link so cancel the link action
 if (getUsuarioSistema() == 1 || getUsuarioSistema() == 2 || getUsuarioSistema() == 3 || getUsuarioSistema() == 5){
	 e.preventDefault();
	 reporteEXCELDiario();
 }else{
...
$('#form_main_atenciones_medicas #limpiar').on('click', function(e){
    e.preventDefault();
    limpiar();
});
</script>