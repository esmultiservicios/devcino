...
function pagination(partida){
    ...
    if($('#form_main_facturacion #profesional').val() == "" || $('#form_main_facturacion #profesional').val() == null){
		profesional = '';
	}else{
		profesional = $('#form_main_facturacion #profesional').val();
	}
	...
	if($('#form_main_facturacion #bs_regis').val() == "" || $('#form_main_facturacion #bs_regis').val() == null){
		dato = '';
	}else{
		dato = $('#form_main_facturacion #bs_regis').val();
	}
