...
function getServicio(){
	...
	$.ajax({
	    ...
	    async: true,
        success: function(data){	
		    $('#formulario_facturacion #factura_servicio_id').html("");
			$('#formulario_facturacion #factura_servicio_id').html(data);			
		}			
     });	
}
...
//INICIO ACCIONES FORMULARIO PACIENTES
...
// FIN ACCIONES FORMUILARIO PACIENTE
