...
$(document).ready(function() {
  $('#form_main_pre_operacion #servicio').on('change', function(){	
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_pre_operacion #colaborador').on('change', function(){
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_pre_operacion #fecha_i').on('change', function(){	
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_pre_operacion #fecha_f').on('change', function(){	
     pagination(1);
  });
});

$(document).ready(function() {
  $('#form_main_pre_operacion #bs_regis').on('keyup', function(){	
     pagination(1);
  });
});

function getServicio(){
    var url = '<?php echo SERVERURL; ?>php/reportes_pre_operacion/getServicio.php';		
	...
	$.ajax({
        ...
        success: function(data){	
		    $('#form_main_pre_operacion #servicio').html("");
			$('#form_main_pre_operacion #servicio').html(data);
		}			
     });	
}
...
function getProfesionales(){
	...
	$.ajax({
        ...
        url: url,
        success: function(data){	
		    $('#form_main_pre_operacion #colaborador').html("");
			$('#form_main_pre_operacion #colaborador').html(data);		
		}			
     });	
}
...
function pagination(partida){
	var colaborador = '';
	var desde = $('#form_main_pre_operacion #fecha_i').val();
	var hasta = $('#form_main_pre_operacion #fecha_f').val();
	var dato = $('#form_main_pre_operacion #bs_regis').val();
	var url = '<?php echo SERVERURL; ?>php/reportes_pre_operacion/paginar.php';	
	
	if($('#form_main_pre_operacion #colaborador').val() == "" || $('#form_main_pre_operacion #colaborador').val() == null){
		colaborador = "";
	}else{
		colaborador = $('#form_main_pre_operacion #colaborador').val();
	}
...
function reporteEXCEL(){
    ...
    url = '<?php echo SERVERURL; ?>php/reportes_pre_operacion/reporte.php?desde='+desde+'&hasta='+hasta+'&colaborador='+colaborador;
...
function reporteEXCELDiario(){		
	...
	if($('#form_main_pre_operacion #servicio').val() == "" || $('#form_main_pre_operacion #servicio').val() == null){
		servicio = "";
	}else{
		servicio = $('#form_main_pre_operacion #servicio').val();
	}
	...
	var url = '<?php echo SERVERURL; ?>php/reportes_pre_operacion/reporteDiarioAtenciones.php?desde='+desde+'&hasta='+hasta+'&servicio='+servicio+'&colaborador='+colaborador;
	window.open(url);			
}
...
$('#form_main_pre_operacion #reporte_excel').on('click', function(e){
 if (getUsuarioSistema() == 1 || getUsuarioSistema() == 2 || getUsuarioSistema() == 3 || getUsuarioSistema() == 5){
    e.preventDefault();
    reporteEXCEL();
 }else{
...
$('#form_main_pre_operacion #reporte_diario').on('click', function(e){ // add event submit We don't want this to act as a link so cancel the link action
 if (getUsuarioSistema() == 1 || getUsuarioSistema() == 2 || getUsuarioSistema() == 3 || getUsuarioSistema() == 5){
	 e.preventDefault();
	 reporteEXCELDiario();
 }else{
...
$('#form_main_pre_operacion #limpiar').on('click', function(e){
    e.preventDefault();
    limpiar();
});
</script>