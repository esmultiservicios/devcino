...
$(document).ready(function() {
	...
	$('#form_main_administrador_secuencia #nuevo_registro').on('click',function(e){
		e.preventDefault();
		funciones();
	...
	$('#form_main_administrador_secuencia #bs_regis').on('keyup',function(){
	  pagination(1);
	}); 

	$('#form_main_administrador_secuencia #servicio').on('change',function(){
	  pagination(1);
	});
	
	$('#form_main_administrador_secuencia #estado').on('change',function(){
	  pagination(1);
	});	
	
	$('#form_main_administrador_secuencia #profesional').on('change',function(){
	  pagination(1);
	});	
...
function pagination(partida){
    ...
    if($('#form_main_administrador_secuencia #empresa').val() == "" || $('#form_main_administrador_secuencia #empresa').val() == null){
		empresa = 0;
	}else{
		empresa = $('#form_main_administrador_secuencia #empresa').val();
	}
	
    if($('#form_main_administrador_secuencia #estado').val() == "" || $('#form_main_administrador_secuencia #estado').val() == null){
		estado = 1;
	}else{
		estado = $('#form_main_administrador_secuencia #estado').val();
	}	
	
	if($('#form_main_administrador_secuencia #bs_regis').val() == "" || $('#form_main_administrador_secuencia #bs_regis').val() == null){
		dato = '';
	}else{
		dato = $('#form_main_administrador_secuencia #bs_regis').val();
	}
...
function getEmpresa(){
	...
	$.ajax({
	    ...
	    async: true,
        success: function(data){
		    $('#form_main_administrador_secuencia #empresa').html("");
			$('#form_main_administrador_secuencia #empresa').html(data);
...
function getEstado(){
	...
	$.ajax({
	    ...
	    async: true,
        success: function(data){
		    $('#form_main_administrador_secuencia #estado').html("");
			$('#form_main_administrador_secuencia #estado').html(data);	
