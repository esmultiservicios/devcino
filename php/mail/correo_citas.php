...
$consultar_expediente = "SELECT a.agenda_id AS 'agenda_id'
    ...
    WHERE pacientes_id = '$pacientes_id' AND a.servicio_id = '$servicio' AND c.puesto_id = '$medico' AND a.status = 1";
...
$from = "Creación de Cita";			   
$asunto = "Creación de Cita";
$CharSet = "UTF-8";
...
$mensaje="
   <table class='table table-striped table-responsive-md btn-table'>
       ...
       <tr>
          <td colspan='2'><center><b><h4>Creación de Cita</h4></b></center></td>
       </tr>
	   <tr>
	       <td colspan='2'><b>Estimado(a) $nombre, se le informa que se ha creado su cita, los detalles de esta a continuación.</b></td>
	   </tr>	   
	   <tr>
	       <td><b>Identidad:</b></td>
		   <td>$identidad</td>		
