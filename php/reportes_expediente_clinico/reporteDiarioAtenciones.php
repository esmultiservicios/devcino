...
//REGISTROS
$registro = "SELECT (CASE WHEN c.paciente = 'N' THEN 'Nuevo' ELSE 'Subsiguiente' END) AS 'Paciente',
COUNT(CASE WHEN DAY(c.fecha) = 1 THEN c.paciente END) AS '1',  
COUNT(CASE WHEN DAY(c.fecha) = 2 THEN c.paciente END) AS '2',
COUNT(CASE WHEN DAY(c.fecha) = 3 THEN c.paciente END) AS '3',
COUNT(CASE WHEN DAY(c.fecha) = 4 THEN c.paciente END) AS '4',
COUNT(CASE WHEN DAY(c.fecha) = 5 THEN c.paciente END) AS '5',
COUNT(CASE WHEN DAY(c.fecha) = 6 THEN c.paciente END) AS '6',
COUNT(CASE WHEN DAY(c.fecha) = 7 THEN c.paciente END) AS '7',
COUNT(CASE WHEN DAY(c.fecha) = 8 THEN c.paciente END) AS '8',
COUNT(CASE WHEN DAY(c.fecha) = 9 THEN c.paciente END) AS '9',
COUNT(CASE WHEN DAY(c.fecha) = 10 THEN c.paciente END) AS '10',
COUNT(CASE WHEN DAY(c.fecha) = 11 THEN c.paciente END) AS '11',  
COUNT(CASE WHEN DAY(c.fecha) = 12 THEN c.paciente END) AS '12',
COUNT(CASE WHEN DAY(c.fecha) = 13 THEN c.paciente END) AS '13',
COUNT(CASE WHEN DAY(c.fecha) = 14 THEN c.paciente END) AS '14',
COUNT(CASE WHEN DAY(c.fecha) = 15 THEN c.paciente END) AS '15',
COUNT(CASE WHEN DAY(c.fecha) = 16 THEN c.paciente END) AS '16',
COUNT(CASE WHEN DAY(c.fecha) = 17 THEN c.paciente END) AS '17',
COUNT(CASE WHEN DAY(c.fecha) = 18 THEN c.paciente END) AS '18',
COUNT(CASE WHEN DAY(c.fecha) = 19 THEN c.paciente END) AS '19',
COUNT(CASE WHEN DAY(c.fecha) = 20 THEN c.paciente END) AS '20',
COUNT(CASE WHEN DAY(c.fecha) = 21 THEN c.paciente END) AS '21',  
COUNT(CASE WHEN DAY(c.fecha) = 22 THEN c.paciente END) AS '22',
COUNT(CASE WHEN DAY(c.fecha) = 23 THEN c.paciente END) AS '23',
COUNT(CASE WHEN DAY(c.fecha) = 24 THEN c.paciente END) AS '24',
COUNT(CASE WHEN DAY(c.fecha) = 25 THEN c.paciente END) AS '25',
COUNT(CASE WHEN DAY(c.fecha) = 26 THEN c.paciente END) AS '26',
COUNT(CASE WHEN DAY(c.fecha) = 27 THEN c.paciente END) AS '27',
COUNT(CASE WHEN DAY(c.fecha) = 28 THEN c.paciente END) AS '28',
COUNT(CASE WHEN DAY(c.fecha) = 29 THEN c.paciente END) AS '29',
COUNT(CASE WHEN DAY(c.fecha) = 30 THEN c.paciente END) AS '30',
COUNT(CASE WHEN DAY(c.fecha) = 31 THEN c.paciente END) AS '31',
COUNT(c.paciente) AS 'Total'
FROM clinico AS c
