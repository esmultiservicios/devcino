...
if($colaborador == ""){
	...
	$where = "WHERE post.colaborador_id = '$colaborador' AND post.fecha BETWEEN '$desde' AND '$hasta'";	
}

//EJECUTAMOS LA CONSULTA DE BUSQUEDA
//REGISTROS
$registro = "SELECT (CASE WHEN post.paciente = 'N' THEN 'Nuevo' ELSE 'Subsiguiente' END) AS 'Paciente',
COUNT(CASE WHEN DAY(post.fecha) = 1 THEN post.paciente END) AS '1',  
COUNT(CASE WHEN DAY(post.fecha) = 2 THEN post.paciente END) AS '2',
COUNT(CASE WHEN DAY(post.fecha) = 3 THEN post.paciente END) AS '3',
COUNT(CASE WHEN DAY(post.fecha) = 4 THEN post.paciente END) AS '4',
COUNT(CASE WHEN DAY(post.fecha) = 5 THEN post.paciente END) AS '5',
COUNT(CASE WHEN DAY(post.fecha) = 6 THEN post.paciente END) AS '6',
COUNT(CASE WHEN DAY(post.fecha) = 7 THEN post.paciente END) AS '7',
COUNT(CASE WHEN DAY(post.fecha) = 8 THEN post.paciente END) AS '8',
COUNT(CASE WHEN DAY(post.fecha) = 9 THEN post.paciente END) AS '9',
COUNT(CASE WHEN DAY(post.fecha) = 10 THEN post.paciente END) AS '10',
COUNT(CASE WHEN DAY(post.fecha) = 11 THEN post.paciente END) AS '11',  
COUNT(CASE WHEN DAY(post.fecha) = 12 THEN post.paciente END) AS '12',
COUNT(CASE WHEN DAY(post.fecha) = 13 THEN post.paciente END) AS '13',
COUNT(CASE WHEN DAY(post.fecha) = 14 THEN post.paciente END) AS '14',
COUNT(CASE WHEN DAY(post.fecha) = 15 THEN post.paciente END) AS '15',
COUNT(CASE WHEN DAY(post.fecha) = 16 THEN post.paciente END) AS '16',
COUNT(CASE WHEN DAY(post.fecha) = 17 THEN post.paciente END) AS '17',
COUNT(CASE WHEN DAY(post.fecha) = 18 THEN post.paciente END) AS '18',
COUNT(CASE WHEN DAY(post.fecha) = 19 THEN post.paciente END) AS '19',
COUNT(CASE WHEN DAY(post.fecha) = 20 THEN post.paciente END) AS '20',
COUNT(CASE WHEN DAY(post.fecha) = 21 THEN post.paciente END) AS '21',  
COUNT(CASE WHEN DAY(post.fecha) = 22 THEN post.paciente END) AS '22',
COUNT(CASE WHEN DAY(post.fecha) = 23 THEN post.paciente END) AS '23',
COUNT(CASE WHEN DAY(post.fecha) = 24 THEN post.paciente END) AS '24',
COUNT(CASE WHEN DAY(post.fecha) = 25 THEN post.paciente END) AS '25',
COUNT(CASE WHEN DAY(post.fecha) = 26 THEN post.paciente END) AS '26',
COUNT(CASE WHEN DAY(post.fecha) = 27 THEN post.paciente END) AS '27',
COUNT(CASE WHEN DAY(post.fecha) = 28 THEN post.paciente END) AS '28',
COUNT(CASE WHEN DAY(post.fecha) = 29 THEN post.paciente END) AS '29',
COUNT(CASE WHEN DAY(post.fecha) = 30 THEN post.paciente END) AS '30',
COUNT(CASE WHEN DAY(post.fecha) = 31 THEN post.paciente END) AS '31',
COUNT(post.paciente) AS 'Total'
FROM postoperacion AS post
INNER JOIN colaboradores AS co
ON post.colaborador_id = co.colaborador_id
".$where."
GROUP BY post.paciente";
...
$fila=2;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte de Usuarios Nuevos y Subsiguientes");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");


$fila=3;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte Post Operación");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");
