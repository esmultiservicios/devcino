...
$objPHPExcel->getActiveSheet()->SetCellValue("O$fila", 'Peso Perdido');
...
if($result->num_rows>0){
	while($registro2 = $result->fetch_assoc()){
	   ...
	   $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", $registro2['peso_perdido']);
