...
$query = "SELECT CONCAT(p.nombre,' ',p.apellido) AS 'paciente', p.email AS 'correo', f.number AS 'numero', sf.prefijo AS 'prefijo', sf.relleno AS 'relleno', f.colaborador_id AS 'colaborador_id'
	FROM facturas AS f
...
if($result->num_rows>=0){
	...
	$para = $factura['correo'];
	$no_factura = $factura['colaborador_id']."_".str_pad($factura['numero'], $factura['relleno'], "0", STR_PAD_LEFT);
...
$de = "facturacion@mentesanahn.com";
$contraseña = 'M3nt3s@n@2020hn05';   
$servidor = "mail.mentesanahn.com";
$puerto = "465";
$SMTPSecure = "ssl"; 
$from = "Factura";		   
...
$url_footer = "";
$url_facebook = "https://www.facebook.com/centrocino";
$url_sitio_web = "https://clinicare.cin-o.com/";
