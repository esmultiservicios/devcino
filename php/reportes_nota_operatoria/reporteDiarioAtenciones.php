...
if($colaborador == ""){
	...
	$where = "WHERE n.colaborador_id = '$colaborador' AND n.fecha BETWEEN '$desde' AND '$hasta'";	
}

//EJECUTAMOS LA CONSULTA DE BUSQUEDA
//REGISTROS
$registro = "SELECT (CASE WHEN n.paciente = 'N' THEN 'Nuevo' ELSE 'Subsiguiente' END) AS 'Paciente',
COUNT(CASE WHEN DAY(n.fecha) = 1 THEN n.paciente END) AS '1',  
COUNT(CASE WHEN DAY(n.fecha) = 2 THEN n.paciente END) AS '2',
COUNT(CASE WHEN DAY(n.fecha) = 3 THEN n.paciente END) AS '3',
COUNT(CASE WHEN DAY(n.fecha) = 4 THEN n.paciente END) AS '4',
COUNT(CASE WHEN DAY(n.fecha) = 5 THEN n.paciente END) AS '5',
COUNT(CASE WHEN DAY(n.fecha) = 6 THEN n.paciente END) AS '6',
COUNT(CASE WHEN DAY(n.fecha) = 7 THEN n.paciente END) AS '7',
COUNT(CASE WHEN DAY(n.fecha) = 8 THEN n.paciente END) AS '8',
COUNT(CASE WHEN DAY(n.fecha) = 9 THEN n.paciente END) AS '9',
COUNT(CASE WHEN DAY(n.fecha) = 10 THEN n.paciente END) AS '10',
COUNT(CASE WHEN DAY(n.fecha) = 11 THEN n.paciente END) AS '11',  
COUNT(CASE WHEN DAY(n.fecha) = 12 THEN n.paciente END) AS '12',
COUNT(CASE WHEN DAY(n.fecha) = 13 THEN n.paciente END) AS '13',
COUNT(CASE WHEN DAY(n.fecha) = 14 THEN n.paciente END) AS '14',
COUNT(CASE WHEN DAY(n.fecha) = 15 THEN n.paciente END) AS '15',
COUNT(CASE WHEN DAY(n.fecha) = 16 THEN n.paciente END) AS '16',
COUNT(CASE WHEN DAY(n.fecha) = 17 THEN n.paciente END) AS '17',
COUNT(CASE WHEN DAY(n.fecha) = 18 THEN n.paciente END) AS '18',
COUNT(CASE WHEN DAY(n.fecha) = 19 THEN n.paciente END) AS '19',
COUNT(CASE WHEN DAY(n.fecha) = 20 THEN n.paciente END) AS '20',
COUNT(CASE WHEN DAY(n.fecha) = 21 THEN n.paciente END) AS '21',  
COUNT(CASE WHEN DAY(n.fecha) = 22 THEN n.paciente END) AS '22',
COUNT(CASE WHEN DAY(n.fecha) = 23 THEN n.paciente END) AS '23',
COUNT(CASE WHEN DAY(n.fecha) = 24 THEN n.paciente END) AS '24',
COUNT(CASE WHEN DAY(n.fecha) = 25 THEN n.paciente END) AS '25',
COUNT(CASE WHEN DAY(n.fecha) = 26 THEN n.paciente END) AS '26',
COUNT(CASE WHEN DAY(n.fecha) = 27 THEN n.paciente END) AS '27',
COUNT(CASE WHEN DAY(n.fecha) = 28 THEN n.paciente END) AS '28',
COUNT(CASE WHEN DAY(n.fecha) = 29 THEN n.paciente END) AS '29',
COUNT(CASE WHEN DAY(n.fecha) = 30 THEN n.paciente END) AS '30',
COUNT(CASE WHEN DAY(n.fecha) = 31 THEN n.paciente END) AS '31',
COUNT(n.paciente) AS 'Total'
...
$fila=3;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Reporte Nota Operatoria");
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");
