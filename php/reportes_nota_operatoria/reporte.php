...
if($result->num_rows>0){
	while($registro2 = $result->fetch_assoc()){
	   ...
	   $objPHPExcel->getActiveSheet()->SetCellValue("N$fila", $registro2['cirujano']);
	   $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", $registro2['asistente']);
