...
while($registro2 = $result->fetch_assoc()){	
	if($type == 1 || $type == 2  || $type == 4){
		$atencion = '<a class="btn btn btn-secondary ml-2" href="javascript:setAtencionNutricion('.$registro2['pacientes_id'].','.$colaborador_id.','.$registro2['servicio_id'].','.$registro2['agenda_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-book-medical fa-lg"></i> Atención</a>';
	}else{
		$atencion = '';
	}
