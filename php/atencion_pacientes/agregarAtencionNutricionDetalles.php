...
$pacientes_id = isset($_POST['pacientes_id']) && $_POST['pacientes_id'] !== '' ? $_POST['pacientes_id'] : 0;
$colaborador_id = isset($_SESSION['colaborador_id']) && $_SESSION['colaborador_id'] !== '' ? $_SESSION['colaborador_id'] : 0;
$servicio_id = isset($_POST['atenciones_servicio_id']) && $_POST['atenciones_servicio_id'] !== '' ? $_POST['atenciones_servicio_id'] : 0;
$atenciones_nutricion_id = isset($_POST['atenciones_nutricion_id']) && $_POST['atenciones_nutricion_id'] !== '' ? $_POST['atenciones_nutricion_id'] : 0;
