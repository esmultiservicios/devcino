...
while($registro2 = $result->fetch_assoc()){	   	
  if ($registro2['expediente'] == 0){
	...
	$tabla = $tabla.'<tr>
	   ...
	   <td>
			<a class="btn btn btn-secondary ml-2" href="javascript:editarRegistro('.$registro2['agenda_id'].','.$registro2['expediente'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-notes-medical fa-lg"></i> Confirmación</a>
			<a class="btn btn btn-secondary ml-2" href="javascript:nosePresntoRegistro('.$registro2['agenda_id'].','.$registro2['pacientes_id'].');void(0);"><div class="sb-nav-link-icon"></div><i class="fas fa-times-circle fa-lg"></i> Ausencia</a>
	   </td>
  </tr>';		
  $i++;
}
