...
if($paginaActual > 1){
	$lista = $lista.'<li class="page-item"><a class="page-link" href="javascript:paginationSeguimiento('.('1,'.$pacientes_id','.$colaborador_id).');void(0);">Inicio</a></li>';
}

if($paginaActual > 1){
	$lista = $lista.'<li class="page-item"><a class="page-link" href="javascript:paginationSeguimiento('.($paginaActual.'-1,'.$pacientes_id.','.$colaborador_id).');void(0);">Anterior '.($paginaActual-1).'</a></li>';
}

if($paginaActual < $nroPaginas){
	$lista = $lista.'<li class="page-item"><a class="page-link" href="javascript:paginationSeguimiento('.($paginaActual.'+1,'.$pacientes_id','.$colaborador_id).');void(0);">Siguiente '.($paginaActual+1).' de '.$nroPaginas.'</a></li>';
}

if($paginaActual > 1){
	$lista = $lista.'<liclass="page-item"><a class="page-link" href="javascript:paginationSeguimiento('.($nroPaginas.','.$pacientes_id','.$colaborador_id).');void(0);">Ultima</a></li>';
}
